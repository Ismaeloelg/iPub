<div class="m-2">
    ...
    @if($pantalla == 'comanda')
        <div class="bg-gray-800 shadow-xl rounded-4xl pt-6 p-2">
            <h2 class="text-4xl font-bold mb-9 text-center">Mesa #{{ $mesa->id }}</h2>

            <div class="flex gap-6 m-5">

                {{-- PRODUCTOS --}}
                <div class="w-3/4">
                    <div class="grid grid-cols-5 gap-4 pb-7">
                        @foreach($categorias as $categoria)
                            <div wire:click="verProductos({{ $categoria->id }})"
                                 class="p-3 rounded-2xl bg-purple-100 shadow text-center border cursor-pointer transition hover:shadow-lg hover:bg-yellow-100 hover:ring-3 ring-purple-100 border-purple-100
                    ...
                    @if($categoriaSeleccionada)
                        <div class="rounded-4xl shadow p-5 m-2/4 ">
